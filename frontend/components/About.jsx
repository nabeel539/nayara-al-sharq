                ...
                <div className='flex flex-col xl:flex-row items-center gap-12 xl:gap-0'>
                    ...
                    <div className='flex-1 flex justify-center xl:justify-start'>
                        <div className='max-w-[540px] text-center xl:text-justify'>
                            ...
                            <p className="mb-6">
                                Nayara Al Sharq is a multidisciplinary contracting company specializing in manpower
                                support services across administration, civil, mechanical, electrical instrumentation,
                                HSE, and warehousing operations.
                            </p>

                            <p className="mb-11 ">
                                From humble beginnings in the 2010s, the company has grown into a trusted industry
                                partner delivering residential, commercial, and industrial projects. With a strong
                                focus on precision, quality, and expertise, we consistently execute solutions that
