import { RiChat1Line, RiMap2Line, RiExternalLinkLine, RiSmartphoneLine } from "react-icons/ri";
                    ...
                    <div className="flex flex-col xl:flex-row h-full gap-[40px] xl:gap-[90px]">
                        ...
                        <div className="w-full xl:max-w-[380px] xl:pr-[70px] xl:border-r xl:border-border/40 h-[640px]">
                            ...
                            <p className="mb-8 text-secondary">
                                Have a question or need expert support for your project? Our team is ready to assist you with reliable guidance and professional solutions.
                            </p>
                            ...
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <a
                                        href="mailto:Nayaracontractingest@outlook.com?subject=Project Inquiry"
                                        className="text-primary font-medium hover:text-accent transition"
                                    >
                                        Nayaracontractingest@outlook.com
                                    </a>
                            ...
                            <div className="flex items-start gap-4 mb-10">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <a href="tel:+966532690401" className="font-medium text-primary hover:text-accent transition">
                                            +966-532690401
                                        </a>
                                        <a href="tel:+966573293200" className="font-medium text-primary hover:text-accent transition">
                                            +966-573293200
                                        </a>
                                        <a href="tel:+966599661645" className="font-medium text-primary hover:text-accent transition">
                                            +966-599661645
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="flex-1">
                            ...
                            <p className="mb-9">
                                Tell us about your project requirements and our team will get back to you with a detailed estimate, tailored solutions, and expert guidance to bring your vision to life.
                            </p>
                            <Form />
                        </div>
                    </div>
