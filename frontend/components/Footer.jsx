                ...
                <div className="flex flex-col xl:flex-row gap-12 py-16">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-border max-w-[270px]">
                            Delivering reliable engineering and construction solutions with precision,
                            innovation, and a commitment to excellence across every project.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 text-border">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <a
                                    href="mailto:Nayaracontractingest@outlook.com"
                                    className="hover:text-accent transition"
                                >
                            ...
                            <li className="flex flex-col">
                                <a href="tel:+966532690401" className="hover:text-accent transition">
                                    +966 532 690 401
                                </a>
                                <a href="tel:+966573293200" className="hover:text-accent transition">
                                    +966 573 293 200
                                </a>
                                <a href="tel:+966599661645" className="hover:text-accent transition">
                                    +966 599 661 645
                                </a>
                            </li>
                    ...
                    <div className="flex-1 text-border">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="hover:text-accent"><Link href="#projects">Projects</Link></li>
                            <li className="hover:text-accent"><Link href="#testimonials">Testimonials</Link></li>
